...
def render_dashboard(filepath):
    ...
    # STWÓRZ SEKCJĘ Z WYKRESAMI SŁUPKOWYMI: divider, header,markdown
    # utwórz dwa wykresy słupkowe: dla wilgotności i dla temperatury (lub temperatur)

    st.divider()
    st.subheader("Wykresy słupkowe")
    st.markdown("Wilgotność i temperatura")
